              ...
              {isLoggedIn ? (
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-[#FAF8F2] hover:bg-[#fffeea] border border-[#EAE6DB] text-brand-charcoal text-xs font-bold uppercase tracking-wider rounded-xl transition-all"
                  >
                    Return to Store
                  </button>
                </div>
