...
export const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end modal-backdrop animate-fade-in" onClick={closeCart}>
      ...
      >
        {/* Drawer Header */}
        <div className="p-4 sm:p-5 border-b border-[#EAE6DB] bg-[#FFFDD0]">
          ...
          <div className="mt-3 bg-white p-2.5 border border-[#EAE6DB]">
            ...
            <div className="w-full bg-[#FFFDD0] h-2 overflow-hidden border border-[#EAE6DB]">
              <div
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-3 divide-y divide-[#EAE6DB]">
          {items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center py-12 space-y-3">
              <div className="w-16 h-16 rounded-full bg-[#FFFDD0] text-brand-lavender flex items-center justify-center">
            ...
            items.map((item) => (
              <div key={item.id} className="flex gap-3 pt-3">
                <img
                  ...
                  className="w-16 h-20 object-cover border border-[#EAE6DB] shrink-0"
                />
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <div className="flex items-center border border-[#EAE6DB] bg-[#FFFDD0] px-2 py-0.5 text-xs font-bold">
                      <button
              ...
              {appliedCoupon ? (
                ...
                <form onSubmit={handleApplyCoupon} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 border border-[#EAE6DB] bg-[#FFFDD0] px-3 py-2 text-xs uppercase font-bold focus:outline-none"
                  />
                  <button
                    type="submit"
                    className="px-4 py-2 bg-[#1A1821] text-white text-xs font-bold uppercase"
                  >
                    Apply
                  </button>
                </form>
