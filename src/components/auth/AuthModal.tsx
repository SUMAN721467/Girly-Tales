        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden animate-scale-in border border-[#EAE6DB]">
          ...
          <div className="relative h-28 sm:h-32 bg-gradient-to-r from-[#8E6FAE] via-[#D86F90] to-[#8E6FAE] p-4 flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] sm:text-[11px] font-bold tracking-[0.25em] text-[#fffeea] uppercase drop-shadow-xs">
              ...
              <div className="text-center py-2 space-y-4 animate-fade-in">
                ...
                <div>
                  <div className="flex items-center justify-center gap-1.5">
                    ...
                    <span className="bg-[#fffeea] text-[#967BB6] border border-[#EAE6DB] text-[9px] font-black uppercase px-1.5 py-0.5 rounded">
                      VIP Member
                    </span>
                  </div>
                ...
                <div className="p-3 bg-[#fffeea]/60 border border-[#EAE6DB] rounded-xl flex items-center justify-center gap-2 text-xs font-bold text-brand-charcoal">
                ...
                <div className="pt-2 flex gap-2.5">
                  <button
                    onClick={closeAuthModal}
                    className="flex-1 py-2.5 bg-[#fffeea] hover:bg-[#FBEFC8] text-brand-charcoal text-xs font-bold uppercase rounded-lg border border-[#EAE6DB] transition-colors"
                  >
                    Continue Shopping
                  </button>
                  <button
                    ...
                    {otpValues.map((digit, idx) => (
                      <input
                        ...
                        className={`w-11 h-12 sm:w-12 sm:h-14 text-center font-bold text-lg sm:text-xl rounded-xl border-2 transition-all focus:outline-none ${
                          digit
                            ? 'border-[#967BB6] bg-[#fffeea]/30 text-[#1A1821]'
