      ...
      >
        <div>
          ...
          <div className="flex items-center justify-between pb-4 border-b border-[#EAE6DB]">
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-full bg-[#FFFDD0] hover:bg-brand-lavender-subtle text-brand-charcoal"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <nav className="py-6 space-y-1 text-sm font-bold uppercase tracking-wider text-brand-charcoal">
            ...
            <button
              ...
              className="w-full text-left py-3 px-3 rounded-xl hover:bg-[#FFFDD0] flex items-center justify-between text-brand-lavender transition-colors"
            >
            ...
            <button
              ...
              className="w-full text-left py-3 px-3 rounded-xl hover:bg-[#FFFDD0] flex items-center justify-between text-amber-700 transition-colors"
            >
              <span className="flex items-center gap-2">
            ...
            <div className="pt-4 border-t border-[#EAE6DB] space-y-1">
              <button
                ...
                className="w-full text-left py-2.5 px-3 rounded-xl hover:bg-[#FFFDD0] text-xs text-brand-muted font-bold flex items-center gap-2"
              >
        ...
        {/* Promo Box at Bottom */}
        <div className="p-4 bg-[#FFFDD0] rounded-2xl border border-[#EBD7DE] text-center space-y-1">
