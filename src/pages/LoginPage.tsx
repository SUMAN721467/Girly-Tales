  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 animate-fade-in space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#EAE6DB]">
        <div>
          <span className="text-[10px] font-black uppercase tracking-widest text-[#967BB6] bg-[#fffeea] border border-[#EAE6DB] px-3 py-1 rounded-full">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold uppercase transition-all ${
                accountTab === 'overview'
                  ...
                  : 'bg-[#FAF8F2] text-brand-charcoal hover:bg-[#fffeea]'
              }`}
            >
              Overview
            </button>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div
                  ...
                  className="p-5 bg-[#fffeea]/60 border border-[#EAE6DB] hover:border-[#967BB6] rounded-3xl cursor-pointer transition-all space-y-2 group shadow-xs"
                >
              ...
              <div className="p-5 bg-[#1A1821] text-white rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs">
                <div className="space-y-1 text-center sm:text-left">
                  ...
                  <p className="text-sm font-bold">Use code <strong className="text-[#fffeea] underline font-mono">GIRLY10</strong> for 10% off today</p>
                </div>
                <button
                  onClick={() => onNavigate('shop')}
