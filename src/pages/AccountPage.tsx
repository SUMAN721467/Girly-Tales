            ...
            <div className="flex items-center gap-2 justify-center sm:justify-start flex-wrap">
              ...
              {isLoggedIn ? (
                isAdmin ? (
                  ...
                  <span className="bg-[#fffeea] text-[#967BB6] border border-[#EAE6DB] text-[10px] font-black uppercase px-2 py-0.5 rounded">
                    VIP Club Member
                  </span>
                )
              ) : (
            ...
            <div className="bg-white border border-[#EAE6DB] rounded-3xl p-6 sm:p-8 shadow-xs space-y-6 animate-fade-in">
              ...
              <div className="p-6 bg-gradient-to-br from-[#FAF8F2] via-white to-[#FAF8F2] border border-[#EAE6DB] rounded-2xl flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6 shadow-2xs">
                ...
                <button
                  type="button"
                  onClick={() => setIsEditingProfile(true)}
                  className="px-4 py-2 bg-white hover:bg-[#fffeea] border border-[#EAE6DB] text-brand-charcoal font-bold text-xs rounded-xl transition-all shadow-2xs flex items-center gap-1.5 cursor-pointer shrink-0"
                >
                ...
                <div className="pt-4 mt-4 border-t border-[#EAE6DB] flex items-center justify-between gap-2 text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3 py-1.5 bg-[#FAF8F2] hover:bg-[#fffeea] border border-[#EAE6DB] text-brand-charcoal font-bold text-xs rounded-xl flex items-center gap-1 cursor-pointer transition-colors"
                    >
          ...
          {selectedOrderForDetail ? (
            <div className="space-y-6 animate-fade-in">
              ...
              <div>
                <button
                  onClick={() => setSelectedOrderForDetail(null)}
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-white hover:bg-[#fffeea] border border-[#EAE6DB] rounded-2xl text-xs font-bold text-brand-charcoal transition-all shadow-xs cursor-pointer active:scale-95"
                >
                ...
                <div className="lg:col-span-5 space-y-6">
                      ...
                      <div className="pt-3 border-t border-[#EAE6DB] space-y-2">
                        ...
                        {selectedOrderForDetail.trackingUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="w-full mt-1 py-2 px-3 bg-[#FAF8F2] hover:bg-[#fffeea] border border-[#EAE6DB] rounded-xl text-[11px] font-bold text-[#967BB6] flex items-center justify-center gap-1.5 transition-colors"
                          >
                  ...
                  <div className="bg-white border border-[#EAE6DB] rounded-3xl p-4 sm:p-5 shadow-xs flex items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#FAF8F2] hover:bg-[#fffeea] border border-[#EAE6DB] text-brand-charcoal text-xs font-bold uppercase tracking-wider rounded-xl transition-all flex items-center gap-1.5 cursor-pointer active:scale-95 shadow-2xs"
                    >
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="bg-white border border-[#EAE6DB] rounded-3xl p-6 sm:p-8 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-[#FAF8F2] hover:bg-[#fffeea] border border-[#EAE6DB] text-brand-charcoal text-xs font-black uppercase tracking-wider rounded-2xl transition-all shadow-xs shrink-0 cursor-pointer"
                >
                  Continue Shopping 🛍️
                </button>
              </div>
              ...
              {userOrders.length === 0 && (
                <div className="py-14 text-center text-brand-muted space-y-3 bg-white rounded-3xl border border-[#EAE6DB]">
                  ...
                  <div className="pt-2 flex items-center justify-center gap-3 flex-wrap">
                    <button
                      onClick={() => onNavigate('shop')}
                      className="px-6 py-2.5 bg-[#FAF8F2] hover:bg-[#fffeea] border border-[#EAE6DB] text-brand-charcoal text-xs font-bold uppercase rounded-2xl shadow-xs cursor-pointer"
                    >
                      Explore Shop
                    </button>
                    {!isLoggedIn && (
